...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class FirebaseAppcheckLibraryAccessors extends SubDependencyFactory {
        private final FirebaseAppcheckDebugLibraryAccessors laccForFirebaseAppcheckDebugLibraryAccessors = new FirebaseAppcheckDebugLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>firebase.appcheck.debug</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public FirebaseAppcheckDebugLibraryAccessors getDebug() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForFirebaseAppcheckDebugLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class FirebaseAppcheckDebugLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public FirebaseAppcheckDebugLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>debug</b> with <b>com.google.firebase:firebase-appcheck-debug</b> coordinates and
         * with version reference <b>firebaseAppcheckDebug</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        /**
         * Dependency provider for <b>v1711</b> with <b>com.google.firebase:firebase-appcheck-debug</b> coordinates and
         * with version reference <b>firebaseAppcheckDebugVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getV1711() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("firebase.appcheck.debug.v1711");
        }
    ...
    public static class PlayServicesLibraryAccessors extends SubDependencyFactory {
        ...
        private final PlayServicesBaseLibraryAccessors laccForPlayServicesBaseLibraryAccessors = new PlayServicesBaseLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>play.services.base</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public PlayServicesBaseLibraryAccessors getBase() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForPlayServicesBaseLibraryAccessors;
        }
    ...
    public static class PlayServicesAuthLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v2070</b> with <b>com.google.android.gms:play-services-auth</b> coordinates and
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getV2070() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("play.services.auth.v2070");
        }
     ...
     */
    @Deprecated
    public static class PlayServicesBaseLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public PlayServicesBaseLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        /**
         * Dependency provider for <b>v1830</b> with <b>com.google.android.gms:play-services-base</b> coordinates and
         * with version reference <b>playServicesBaseVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getV1830() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("play.services.base.v1830");
        }
    ...
    public static class StripeLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>stripeAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>firebaseAppcheckDebug</b> with value <b>18.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getFirebaseAppcheckDebug() { return getVersion("firebaseAppcheckDebug"); }

        /**
         * Version alias <b>firebaseAppcheckDebugVersion</b> with value <b>17.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getFirebaseAppcheckDebugVersion() { return getVersion("firebaseAppcheckDebugVersion"); }
        ...
        /**
         * Version alias <b>playServicesBase</b> with value <b>18.6.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>playServicesBaseVersion</b> with value <b>18.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPlayServicesBaseVersion() { return getVersion("playServicesBaseVersion"); }
        ...
        /**
         * Version alias <b>stripeAndroid</b> with value <b>21.6.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getStripeAndroid() { return getVersion("stripeAndroid"); }
